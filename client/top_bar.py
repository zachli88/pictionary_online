...
class TopBar:
    ...
    def draw(self, win):
        ...
        underscores = self.round_font.render(TopBar.underscore_text(self.word), 1, (0, 0, 0))
        win.blit(underscores, (self.x + self.width / 2 - underscores.get_width() / 2, self.y + self.height / 2 - underscores.get_height() / 2 + 10))
